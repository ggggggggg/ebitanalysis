...
toAnalyzeLJHFilename = "/data/20181204_E/20181204_E_chan1.ljh" # point to one specific channel, it will find all channels
...
ws=devel.WorstSpectra(data,np.arange(8000))
ws.plot()
...
data.plot_hist(np.arange(350,4000,5),"p_energy",axis=plt.gca())
