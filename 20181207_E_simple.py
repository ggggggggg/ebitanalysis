...
dirname = "/data/20181207_A" # directory where we find the data to be analyzed
ndirname = "/data/20181207_B" # the associated directory for the noise
...
for ds in data:
        cal_b_to_a(ds_a=data.channel[3],ds_b=ds,npeaks=3,diagnose_plots=False)
...
peaks_inds_sorted = peaks_inds[np.argsort(peakscounts)][::-1][:3]
