...
data.calibrate("p_filt_value_phc",[3139.5927,3104.15],diagnose=False,forceNew=True,fit_range_ev=10,nextra=0,size_related_to_energy_resolution=5)
...
h5 = h5py.File(data.shortname()+".h5","w")
