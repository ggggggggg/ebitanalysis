...
toAnalyzeLJHFilename = "/data/20181203_D/20181203_D_chan1.ljh" # point to one specific channel, it will find all channels
...
data.calibrate("p_filt_value_phc",[3139.5927,3104.15,3321],name_ext="_ext",diagnose=False,forceNew=True,fit_range_ev=10,nextra=0,size_related_to_energy_resolution=5)
