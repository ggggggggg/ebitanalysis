...
data.setOutputDir(baseDir=d, deleteAndRecreate=True, suffix = "_Ir_focus_output")
...
ds.calibrationPlanAddPoint(2128, "O He-Like 1s2p + 1s2s", states="Ir")
ds.calibrationPlanAddPoint(2421, "O H-Like 2p", states="Ir")
ds.calibrationPlanAddPoint(2864, "O H-Like 3p", states="Ir")
...
with data.outputHDF5 as h5:
    # fitters = data.qualityCheckLinefit("O H-Like 4p", positionToleranceAbsolute=2,
