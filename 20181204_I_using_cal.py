...
toAnalyzeLJHFilename = "/data/20181204_I/20181204_I_chan1.ljh" # point to one specific channel, it will find all channels
...
data.plot_hist(np.arange(8000),"p_energy")
