...
toAnalyzeLJHFilename = "/data/20181204_C/20181204_C_chan1.ljh" # point to one specific channel, it will find all channels
...
data = mass.TESGroup(filenames[:20],hdf5_filename=toAnalyzeHDF5Filename)
data.summarize_data()
