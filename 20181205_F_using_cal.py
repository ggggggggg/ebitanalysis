...
calHdf5Filename = "/data/20181205_C/20181205_C_mass.hdf5"
toAnalyzeLJHFilename = "/data/20181205_F/20181205_F_chan1.ljh" # point to one specific channel, it will find all channels
...
data.convert_to_energy("p_filt_value_dc",calname="p_filt_value_dc")
